...
const { registrarUsuario, iniciarUsuario, obtenerPerfil, logOut, ejecutar, actualizarCodigo, eliminarUsuarios, obtenerCodigoEstado, actualizarEstado } = require('../controllers/userControllers')
...
router.get('/get-code', auth, obtenerCodigoEstado)
